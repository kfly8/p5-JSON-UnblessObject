...
is unbless_with_json_spec($entity, { a => JSON_TYPE_INT }),
   { a => 123 };

is unbless_with_json_spec($entity, { b => JSON_TYPE_STRING }),
   { b => 'HELLO' };

is unbless_with_json_spec($entity, { a => JSON_TYPE_INT, b => JSON_TYPE_STRING }),
   { a => 123, b => 'HELLO' };
